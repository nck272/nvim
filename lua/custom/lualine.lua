...
custom_theme.normal.c.bg = colors.black_light
custom_theme.normal.c.fg = colors.fg
custom_theme.insert.c.bg = colors.black_light
custom_theme.insert.c.fg = colors.fg
custom_theme.visual.c.bg = colors.black_light
custom_theme.visual.c.fg = colors.fg
custom_theme.replace.c.bg = colors.black_light
custom_theme.replace.c.fg = colors.fg
custom_theme.command.c.bg = colors.black_light
