...
set(0, "@lsp.type.builtinAttribute", { link = "Keyword" })
...
set(0, "@lsp.type.enumMember", { link = "Identifier" })
set(0, "@lsp.typemod.enumMember", { link = "Identifier" })
set(0, "@lsp.type.static", { link = "Constant" })
set(0, "@lsp.type.lifetime", { link = "Keyword" })
