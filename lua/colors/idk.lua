...
Color.new("yellow", "#d0b892")
Color.new("blue", "#72D0C5")
Color.new("aqua", "#87ffde")
Color.new("cyan", "#55FFFF")
Color.new("purple", "#ffa500")
Color.new("violet", "#6ceba0")
Color.new("orange", "#ffa500")
Color.new("brown", "#d0b892")
Color.new("mint", "#6ceba0")

Color.new("dark_blue", "#3ad0b5")
...
Group.new("CursorLine", nil, c.line_fg)

Group.new("@comment", c.green, nil, s.none)
Group.new("@constant", c.aqua, nil, s.none)
Group.new("@constant.builtin", c.aqua, nil, s.none)
Group.new("@function", c.yellow, nil, s.none)
Group.new("@function.bracket", g.Normal, g.Normal)
Group.new("@keyword", c.red, nil, s.none)
Group.new("@keyword.faded", g.nontext.fg:light(), nil, s.none)
Group.new("@number", c.aqua, nil, s.none)
Group.new("@module", c.aqua, nil, s.none)
Group.new("@string", c.dark_blue, nil, s.none)
Group.new("@property", c.white)
Group.new("@variable", c.superwhite, nil)
Group.new("@variable.builtin", c.orange, g.Normal)
Group.new("@type", c.violet, g.Normal)

Group.new("@lsp.type.builtin", c.pink, g.Normal)
Group.new("@lsp.type.enumMember", c.aqua, g.Normal)
Group.new("@lsp.type.namespace", c.mint, g.Normal)
Group.new("@lsp.type.type", c.violet, g.Normal)
Group.new("@lsp.typemod.variable.static", c.white, g.Normal)
