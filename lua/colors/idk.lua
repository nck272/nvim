...
set(0, "Namespace", { fg = colors.keyword })
...
set(0, "@lsp.typemod.enumMember", { link = "Type" })
...
set(0, "@lsp.typemod.variable.static", { link = "Identifier" })
set(0, "@lsp.typemod.macro.declaration", { link = "Identifier" })
set(0, "@lsp.typemod.variable.static", { link = "Static" })
