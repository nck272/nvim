...
set(0, "CursorLineNr", { fg = colors.orange, bg = colors.bg })
...
set(0, "Identifier", { fg = colors.text })
...
set(0, "@lsp.type.builtinType", { link = "Type" })
...
set(0, "@lsp.type.punctuation", { link = "Punctuation" })
...
set(0, "@lsp.typemod.variable.declaration", { link = "Identifier" })
set(0, "@lsp.typemod.macro.declaration", { link = "Constant" })
...
local function set_buffer_line()
  for name, _ in pairs(vim.api.nvim_get_hl(0, {})) do
    if name:match("^BufferLine") then
      ...
      local cur_fg = name:match("Selected$") and colors.fg or "#AAAAAA"
